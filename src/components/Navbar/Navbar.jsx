...
export default function Navbar(props) {
  ...
  const handleNavigation = (path) => {
    if (user || path === '/home' || path === '/products') {
      navigate(path);
    } else {
  ...
  return (
    <div className={styles.NavbarLayout}>
      <div onClick={() => handleNavigation('/home')} className={`${styles.NavBarBtn} ${props.selectedMenu === 'Home' ? `${styles.NavBarBtnSelected}` : ''}`}>
        <HomeIcon fill={props.selectedMenu === 'Home' ? `var(--primary-default)` : `var(--gray-40)`} />
        <div>홈</div>
      </div>
      <div onClick={() => handleNavigation('/products')} className={`${styles.NavBarBtn} ${props.selectedMenu === 'Shop' ? `${styles.NavBarBtnSelected}` : ''}`}>
      ...
      <div onClick={() => handleNavigation('/mypage')} className={`${styles.NavBarBtn} ${props.selectedMenu === 'MyPage' ? `${styles.NavBarBtnSelected}` : ''}`}>
